...
if __name__ == "__main__":
    ...
    # Load the data.
    (x_acc_tra, x_att_tra, y_HIC_tra, y_AIS_tra), (x_acc_val, x_att_val, y_HIC_val, y_AIS_val) = load_data()
        ...
        for Emb_size in [64, 128, 256]:
            for (ratio_E, ratio_D) in [(40000, 4000), (80000, 8000), (20000, 2000), (20000, 4000), ]:
                for Learning_rate in [0.01, 0.003, 0.001, 0.0003, 0.0001]:
                    ...
                    model_s = backbones.S2S(Emb_size, ).cuda()
...
if __name__ == "__main__":
    ...
    macs, params = profile(model, inputs=(x_att_val[:1, :], ))
